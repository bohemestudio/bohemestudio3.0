...
//RESPONSIVE NAV MODULE ==================================================================================

ResponsiveNavModule = (function() {
    ...
    responsiveNavModule = function(){
        ...
        $("#mobile-navigation-trigger").click(function(e){
            ...
            var mobileNavigationState = $("#mobile-navigation").attr("class");
            var leftMove, contentLeftMove;

            if( mobileNavigationState != "active" ){
                leftMove = "0px";
                contentLeftMove = "100px";
            } else{
                leftMove = "-100px"
                contentLeftMove = "0px";
            }

            $("#mobile-navigation-trigger").toggleClass("active");
            $mobileNavigation.toggleClass("active");

            //Animate all the content elements
            $mobileNavigation.animate(
                {left: leftMove}, 500
            );

            $("#bohemestudio-content #content").animate(
                {marginLeft: contentLeftMove}, 500
            );

            $("#bohemestudio-content #follow").animate(
                {marginLeft: contentLeftMove}, 500
            );
...
var loadModules = function(){
    ...
    //Common modules
    //console.log("LOADING... RESPONSIVE NAV MODULE");
    ResponsiveNavModule.init();
